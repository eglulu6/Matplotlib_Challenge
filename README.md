...
* Calculate the final tumor volume of each mouse across four of the most promising treatment regimens: Capomulin, Ramicane, Infubinol, and Ceftamin. Calculate the quartiles and interquartile range and quantitatively determine if there are any potential outliers across all four treatment regimens.
...
* Calculate the correlation coefficient (https://www.youtube.com/watch?v=xZ_z8KWkhXE) and linear regression model (https://www.youtube.com/watch?v=nk2CQITm_eo) between mouse weight and average tumor volume for the Capomulin treatment. Plot the linear regression model on top of the previous scatter plot.
